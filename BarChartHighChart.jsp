    ...
    $.ajax({
		...
		success : function(data){
			...
			for(var j in data) {
				...
				cityName.push(data[j].city);
				docCount1.push(data[j].count);
				min.push(data[j].min);
				max.push(data[j].max);
				avg.push(data[j].avg);
				sum.push(data[j].sum);
			...
			HighChart.destroy();	
			 ...
			 chartdata = {
						...
						datasets: [
							{
								label: "Maximun Balance of CityWise  ",
								fill: false,
								lineTension: 0.1,
							...
							{
								label: "Minium Balance of CityWise",
								fill: false,
								lineTension: 0.1,
			 ...
			 /*   chart1 = new Chart(ctxPie, {
			   ...
			   */
			    ...
			    //pie chart data
			     data2 = {
			        ...
			        datasets: [
			            {
			             //   label: "Average Balance of City wise",
			                data:  avg,
			                backgroundColor: [
			  ...
			  var databar = {
				        ...
				        datasets: [
				            {
				                label: "Sum Balance of City Wise",
				                data: sum,
				                backgroundColor: [
				                  "green",
				                	 "#FAEBD7",
...
$(document).ready(function(){
	...
	$.ajax({
		...
		url : '<%=application.getContextPath()%>/GetBankDetailsState',
										type : "POST",
										success : function(data) {
											console.log(data);
